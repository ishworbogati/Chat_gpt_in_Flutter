...
class _ChatScreenState extends State < ChatScreen > {
  ...
  String apiKey = "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";
  Future < void > _sendMessage() async {
    ...
    ChatMessage botMessage = ChatMessage(text: response.toString(), sender: "Chat-Gpt");
    // Refresh the page
    setState(() {
  ...
  Widget _buidTextComposer() {
    return Row(children: [
      Expanded(child: TextField(controller: _controller, decoration: const InputDecoration.collapsed(hintText: "Send a message"), ), ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: Column(children: [
        ...
        Container(decoration: const BoxDecoration(), child: _buidTextComposer(), )
      ], ), ), );
  }
}